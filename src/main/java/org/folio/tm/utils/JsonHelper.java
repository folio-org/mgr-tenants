...
public class JsonHelper {
  ...
  /**
   * Converts {@link String} value as {@link JsonNode} object tree.
   *
   ...
   * Converts {@link String} value as {@link JsonNode} object tree.
   *
   * @param inputStream - json value as {@link String} object
   */
   ...
   * @return converted {@link T} object from input stream
   */
  public <T> T parse(InputStream inputStream, TypeReference<T> valueType) {
    if (inputStream == null) {
      return null;
    }
    try {
